...
parser.add_argument('--base_vllm_url', type=str, default='https://api.vectorengine.ai/v1', help='base_vllm url')# http://localhost:8006/v1
parser.add_argument('--judge_vllm_url', type=str, default='https://api.vectorengine.ai/v1', help='judge_vllm url') # http://localhost:8007/v1
parser.add_argument('--api_key', type=str, default='sk-pqQMGWFk3QDIwDubCC4AAGVh1JigOAh1d6yowtZdzQZmttiC', help='api_key')
