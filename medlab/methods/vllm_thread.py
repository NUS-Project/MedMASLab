...
class VLLMBatchInferenceManager:
    ...
    def __init__(self, model=None, root_path=None, batch_size=10, timeout=0.5, vllm_url="http://localhost:8000/v1"):
        ...
        self.client = OpenAI(
            api_key="sk-mv6kM993UUIQtgehP0M0foy6boiTXYFEx13616Jtby0DveMw",
